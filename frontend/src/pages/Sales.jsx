...
import { Search, Plus, Edit, Trash2, X, Calendar, AlertCircle, Building, Archive, Calculator } from 'lucide-react';
            ...
            {['C', '(', ')', '/', '7', '8', '9', '*', '4', '5', '6', '-', '1', '2', '3', '+', '0', '.', '='].map((btn) => (
              <button
                ...
                className={`h-11 rounded-lg flex items-center justify-center transition-all ${
                  btn === '='
                    ? 'bg-gradient-to-r from-green-600 to-teal-600 text-white hover:opacity-95 col-span-2'
                    : btn === 'C'
